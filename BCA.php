...
<?php
include 'cnn.php';
$sql = "SELECT id, firstname, lastname,dob,course,image FROM addstudent WHERE course='BCA'";
...
if ($result->num_rows > 0) {
    ...
    <th colspan= "2"> Action </th>
     ...
     <?php
include 'cnn.php';
$sql = "SELECT ID, firstname, lastname,course,dob,image FROM addstudent WHERE course='BCA'";
$result = $conn->query($sql);
$i=0;
if ($result->num_rows > 0) {
...
?>
   ...
   <td><a href="delete/deletestudentbca.php?ids=<?php echo $row["ID"]; ?>"><img src="delet.png" style="height:24px;width:22px"></a></td>
