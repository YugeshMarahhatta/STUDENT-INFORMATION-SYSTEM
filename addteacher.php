...
<a href="dashbord.php" ><h1> STUDENT INFORMATION SYSTEM </h1></a><br>
<a href="dashbord.php"> <p>GO TO DASHBOARD <br></p> </a>
  <div class="fullform">
  <marquee>Fil up the Teacher Details</marquee>
  <br><br>
  <center>
	<form method="post" action="teacherprocess.php" id="form" enctype="multipart/form-data">
    ...
    <center>
        ...
        <input type="file" name="image" class="hov">
        <br>
